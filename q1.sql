...
call add_full_property(1, 1, 'Swimming Pool', '2023-05-01', '2024-01-23', 20000, 20, 1500, 1324, 6, 3, 0, 3, 'lala', 'Lalu Nagar', 'Hyderabad', 432111, 'Telangana');
-- select * from ADDRESS;
...
call add_full_user('Shantanu', 'lifewe', 22, '103', 'Pandit Wari', 'Dehradun', 110076, 'Uttrakhand', 4, 27638185362, 3891367257);
